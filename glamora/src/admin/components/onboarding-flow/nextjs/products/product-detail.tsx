  ...
  return (
    <div>
      <div className="flex flex-col gap-2">
        <Text>
          We have now created a few sample products in your Home Wizardry store. You can scroll down to see what the Product Detail view looks like in the Admin dashboard.
