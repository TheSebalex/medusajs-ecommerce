          ...
          {({ open, close }) => (
            <>
              ...
              <Transition
                ...
                leaveTo="opacity-0"
              >
                <Popover.Panel className="flex flex-col ml-auto max-w-[96vw] mr-0 absolute w-full pr-4 sm:pr-0 sm:w-1/3 2xl:w-1/4 sm:min-w-min h-[calc(100vh-1rem)] z-30 inset-x-0 text-sm text-ui-fg-on-color m-2 backdrop-blur-2xl">
