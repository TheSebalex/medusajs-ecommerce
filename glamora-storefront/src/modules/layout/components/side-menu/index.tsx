          ...
          {({ open, close }) => (
            <>
              ...
              <Transition
                ...
                leaveTo="opacity-0"
              >
                <Popover.Panel className="flex flex-col ml-auto max-w-[96vw] mr-0 absolute w-full pr-4 sm:pr-0 sm:w-1/4 2xl:w-1/5 h-[calc(100vh-1rem)] z-30 inset-x-0 text-sm text-ui-fg-on-color m-2 backdrop-blur-2xl">
                  <div data-testid="nav-menu-popup" className="flex flex-col h-full bg-[rgba(3,7,18,0.5)] rounded-rounded justify-between p-6">
                    ...
                    <div className="flex flex-col gap-y-6">
                      ...
                      <Text className="flex justify-between text-pretty txt-compact-small">
                        © {new Date().getFullYear()} Home Wizardry Store. All rights
                        reserved.
                      </Text>
                    </div>
                  </div>
